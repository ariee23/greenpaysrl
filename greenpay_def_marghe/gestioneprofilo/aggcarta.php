...
<head>
	...
	<script type="text/javascript">
		...
		function today(){
			...
			var yyyy = today.getFullYear(); //bisogna avere almeno 16 anni per registrarsi
...
<?php
			...
			Carta di credito già presente.</div>
		<?php
			}
		?>
...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg-8 my-col3">
			<h4>Collega una carta</h4>
			<hr>
			<form method="post" action="main.php" onsubmit="return validaAggCarta()">
			  <div class="form-group">
			   ...
			   <label for="intestatario">Intestatario:</label>
				<input type="text" class="form-control" id="intestatario" name="intestatario" placeholder="Nome Cognome">
			  ...
			  <div class="form-group">
				...
				<select name="tipocarta" id="tipocarta" class="form-control">
				  <option value="Mastercard">Mastercard</option>
				  <option value="Visa">Visa</option>
				  <option value="AmericanExpress">AmericanExpress</option>
				</select>
				</div>
			  <button type="submit" name="submit9" class="btn btn-success">Avanti</button>
			</form>
