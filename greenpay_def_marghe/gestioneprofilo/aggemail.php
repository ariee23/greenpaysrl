...
<nav class="navbar navbar-expand-md navbar-dark bg-success sticky-top">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		...
		<ul class="navbar-nav ml-auto">
			...
			?>
			<a href="../gestionepagamenti/richieste.html" class="nav-link notification">
...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg-6 my-col3">
			<h4>Aggiungi indirizzo email</h4>
			<hr>
			<form  method="post" action="main.php" onsubmit="return validaAggEmail()">
			  <div class="form-group">
				<label for="email">Email:</label>
				<input type="text" class="form-control" name="email" id="email">
				<small id="errore1" class="errore"></small>
			  </div>
			  <button type="submit" name="submit3" class="btn btn-success">Avanti</button>
			</form>
		</div>
	</div>
</div>
