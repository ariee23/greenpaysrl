...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg-6 my-col3">
			<h4>Modifica indirizzo email</h4>
			<hr>
			<?php
				$email = $_GET['email2'];
				echo "<form  method='post' action=\"main.php?email2=".$email."\" onsubmit='return validaAggEmail()'>";
			?>
			 ...
			 <div class="form-check form-group">
			  ...
			  <button type="submit" name="submit8" class="btn btn-success">Avanti</button>
			</form>
		</div>
	</div>
</div>
