...
<nav class="navbar navbar-expand-md navbar-dark bg-success sticky-top">
 ...
 <div class="collapse navbar-collapse" id="navbarResponsive">
   <ul class="navbar-nav mr-auto">
     ...
     <li class="nav-item">
     <a class="nav-link active" href="#">Invia e Richiedi</a>
     </li>
     <li class="nav-item">
...
<ul class="nav nav-tabs nav-2 nav-justified">
 <li class="nav-item">
   <a class="nav-link active" href="#">Invia</a>
 </li>
 <li class="nav-item">
...
<div class="container-fluid padding">
 <div class="row justify-content-center">
   <div class="col-lg-6 my-col5">
     <h4>Invia Denaro</h4>
     <hr>
     <p class="p3">Selezionare il tipo di utente a cui inviare denaro</p>
     <div class="text-center">
     <a href="invia.php" class="btn btn-success">Utente Privato</a>
     <a href="scegliperiodico.php" class="btn btn-success">Utente Business</a>
     </div>
   </div>
   </div>
 </div>
